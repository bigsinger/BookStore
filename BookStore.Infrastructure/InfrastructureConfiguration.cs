...
public static class InfrastructureConfiguration {
    ...
    private static IServiceCollection AddDatabase(
        ...
        IConfiguration configuration)
        => services
            .AddDbContext<BookStoreDbContext>(options => options.UseMySql(configuration.GetDefaultConnectionString(),
                ServerVersion.AutoDetect(configuration.GetDefaultConnectionString())))
